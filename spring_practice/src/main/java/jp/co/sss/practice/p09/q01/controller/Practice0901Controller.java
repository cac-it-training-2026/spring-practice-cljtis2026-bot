...
public class Practice0901Controller {
    ...
    public String inputPersonalInfo(@ModelAttribute PersonalInfoForm personalInfoForm) {

		return "practice09/01/info_input";
    }
	
	@RequestMapping(path = "/personal_info/check",method = RequestMethod.POST)
    public String checkPersonalInfo(@Valid @ModelAttribute PersonalInfoForm personalInfoForm, 
